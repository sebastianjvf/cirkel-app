let baseUrl = 'https://cirkelapp.com/';
let userEndpoint = 'users/';

function sendRequest(url, method, callback, JSON) {
	// Make a request
	...
	window.addEventListener('', function(event) {}, useCapture)
...
sendRequest(baseUrl + userEndpoint, 'POST', function(dataReceived) {}, '');
...
/* REQUEST THE GEO DATA ON LOG IN */
